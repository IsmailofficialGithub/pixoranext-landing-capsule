...
const Choose = () => {
    ...
    return (
        <section className="choose-section w-full h-dvh p-8 pt-10">
            <p className='text-[.7rem] text-[#eae5dd] choose-subtitle uppercase tracking-widest'>Our Core AI Foundation</p>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-16'>
                    <p>Built with enterprise-grade security and a self-learning loop, our AI platform scales with your business needs without requiring constant human intervention.</p>
                </div>
                <div className='lg:w-1/2 w-full'>
                    <div className=" lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd] uppercase tracking-widest">Every Pixoranest AI solution is built on these principles:</p>
                    </div>
