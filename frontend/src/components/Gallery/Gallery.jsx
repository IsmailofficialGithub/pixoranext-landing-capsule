...
const Gallery = () => {
    ...
    // Generate repeating Pixoranest elements
    ...
    return (
        <section className="gallery-page4" ref={pageRef}>
            ...
            <div className="gallery-background">
                ...
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        ...
                        <h3>Custom roadmap for AI integration, ensuring your business <br /> leverages the latest automation trends for maximum ROI.</h3>
                    </div>
            ...
            <div id="gallery-second" className="gallery-background2">
                <img src={gbg2} alt="AI Execution" />
                <div className="gallery-topText">
                    <h4>Direct Automation Execution</h4>
                    <h3>(Scroll)</h3>
                </div>
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        <BsFillPlusCircleFill className='w-8 h-8 text-[#b1a696]' />
                        <h3>Deploying production-ready AI agents and sophisticated <br /> workflows that replace manual intervention with smart loops.</h3>
                    </div>
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#4f4b48]">
            ...
            <div id="gallery-third" className="gallery-background2">
                <img src={gbg3} alt="AI Optimization" />
                <div className="gallery-topText">
                ...
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        <BsFillPlusCircleFill className='w-8 h-8 text-[#b1a696]' />
                        <h3>Analyzing performance metrics and refining AI models <br /> to ensure your digital ecosystem grows stronger every day.</h3>
                    </div>
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#4f4b48]">
