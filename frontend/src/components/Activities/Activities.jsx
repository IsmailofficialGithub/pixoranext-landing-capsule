...
const Activities = () => {
    ...
    return (
        <section className="activities-section w-full h-[120vh] p-8 mt-16">
            <p className='text-[.7rem] font-bold text-[#eae5dd] activities-subtitle uppercase tracking-widest'>Our Methodology</p>
            ...
            <div className="activities-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full'>
                    <div className="lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd] text-nowrap uppercase tracking-widest">Pixoranest project lifecycle phases:</p>
                    </div>
                    <div className="flex flex-col justify-start items-start gap-5 mt-8 mr-14">
                        <div className="w-full mr-14">
                            <div className="flex justify-between w-full mb-4">
                                <h1 className="text-[#b1a696] text-xl">Discovery & Research</h1>
                                <p className="text-[#b1a696] text-[0.7rem]">Week 1-2</p>
                            </div>
                        ...
                        <div className="w-full mr-14">
                            <div className="flex justify-between w-full mb-4">
                                <h1 className="text-[#b1a696] text-xl">Design & Prototype</h1>
                                <p className="text-[#b1a696] text-[0.7rem]">Week 3-4</p>
                            </div>
                            <div className="relative z-9 w-full h-[0.1rem] bg-[#4f4b48]">
                        ...
                        <div className="w-full mr-14">
                            <div className="flex justify-between w-full mb-4">
                                <h1 className="text-[#b1a696] text-xl">Development & Launch</h1>
                                <p className="text-[#b1a696] text-[0.7rem]">Week 5-8</p>
                            </div>
                            <div className="relative z-9 w-full h-[0.1rem] bg-[#4f4b48]">
                ...
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-0'>
                    <p>We believe in a systematic approach to digital success. From initial discovery to final optimization, our team ensures every product is built for scale, performance, and maximum impact on your business growth.</p>
                </div>
            </div>
