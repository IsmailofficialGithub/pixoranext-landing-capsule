        ...
        <div className="preloader relative z-51">
            <div className="preloader-progress">
                ...
                <div className="preloader-logo">
                    <h1 ref={preloaderLogoRef} className="logo-text">Pixoranest</h1>
                </div>
            </div>
            ...
            <div className="preloader-content">
                <div className="preloader-footer">
                    <p>
                        Intelligent systems evolving through code and logic, where data 
                        finds its purpose, and future aligns with innovation.
                    </p>
                </div>
            </div>
